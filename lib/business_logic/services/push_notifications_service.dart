...
void checkConditionsAndNotify(BuildContext context, DateTime lastDrenchDate,
    int fecalEggCount, String weatherConditions, int effectivePeriodDays) {
  ...
  final reInfectionRisk =
      ((weatherConditions == 'warm_humid') && (fecalEggCount > 0))
          ? 'high'
          : 'low';
